...
drone = tello.Tello()                       # a - 6 rows below
drone.connect()
...
while True:
    ...
    if cv2.waitKey(1) & 0xFF == ord('q'):
        # cv2.imwrite("../img/red_circle.jpg", img)
        drone.send_rc_control(0, 0, 0, 0)               # g - 1 row below   -> '
        time.sleep(0.2)
        drone.land()
        drone.streamoff()
        break
